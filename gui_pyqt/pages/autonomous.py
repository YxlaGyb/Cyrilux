...
from gui_pyqt.theme import HackerTheme, DARK_PALETTE
from gui_pyqt.widgets.realtime_chart import RealtimeChart
from gui_pyqt.widgets.log_viewer import LogViewer
from gui_pyqt.widgets.metric_card import MetricCard
from gui_pyqt.worker import AutonomousWorker
...
class AutonomousPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._lr_edit = QLineEdit("1e-4", objectName="paramInput")
        cfg_form.addRow("lr:", self._lr_edit)
    ...
    def _start_auto(self) -> None:
        ...
        self._worker = AutonomousWorker(
            ...
            lr=float(self._lr_edit.text() or "1e-4"),
