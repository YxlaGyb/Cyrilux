...
启动:
    from gui_pyqt import launch_gui
    launch_gui()
"""
...
from gui_pyqt.theme import HackerTheme, FONT_FAMILY, FONT_SIZE_BASE
from gui_pyqt.state_bridge import ExperimentStateSignals, bridge_state
...
class MainWindow(QMainWindow):
    ...
    def _register_pages(self) -> None:
        ...
        _page_specs: list[tuple[str, str, tuple]] = [
            ("dashboard", "gui_pyqt.pages.dashboard", ("DashboardPage", self._bridge, self._theme)),
            ("training",   "gui_pyqt.pages.training",   ("TrainingPage", self._bridge, self._theme, self._signals)),
            ("continual",  "gui_pyqt.pages.continual",  ("ContinualPage", self._bridge, self._theme)),
            ("evaluation", "gui_pyqt.pages.evaluation", ("EvaluationPage", self._bridge, self._theme)),
            ("autonomous", "gui_pyqt.pages.autonomous", ("AutonomousPage", self._bridge, self._theme)),
            ("data_manager","gui_pyqt.pages.data_manager",("DataManagerPage", self._bridge, self._theme)),
            ("checkpoints","gui_pyqt.pages.checkpoints",("CheckpointsPage", self._bridge, self._theme)),
            ("config_templates","gui_pyqt.pages.config_templates",("ConfigTemplatesPage", self._bridge, self._theme)),
        ]
