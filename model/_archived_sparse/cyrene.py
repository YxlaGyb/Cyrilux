"""Cyrene 模型 — DEPRECATED · 稀疏存档管线

DEPRECATED (117 轮 Round 1): 稀疏 CyreneModel 已从活动机体解耦。
活跃主线 = model.dense.DensePCNet; model_cyrene.py 已重写为 dense 门面。
本文件保留原 sparse 版 CyreneModel 实现作参考, 不参与任何活动 import 链。
