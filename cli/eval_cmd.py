...
def all(
    ...
    from core.evaluation import run_full_evaluation
    ...
    lm_cfg = MiniMindConfig(hidden_size=256, num_hidden_layers=4, use_moe=False)
    ...
    from core.evaluation import create_eval_loader
...
def language(
    ...
    from core.evaluation import run_full_evaluation, create_eval_loader
    from model.pc_layers import PCLocalDynamicMiniMind, load_pc_checkpoint
    from model.model_minimind import MiniMindConfig
    from core.trainer_utils import setup_seed
    import torch
