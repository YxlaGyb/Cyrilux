...
import typer
from cli.utils import resolve_path, load_config
...
def training_options(
    ...
    enable_qat: bool = typer.Option(True, "--qat/--no-qat", help="启用 4bit QAT (默认开启)"),
    ...
    return dict(
        ...
        enable_qat=enable_qat, enable_amp=enable_amp, use_cuda_graphs=use_cuda_graphs,
...
def from_config(
    ...
    config_obj = TrainingConfig(
        ...
        enable_qat=quant_cfg.get("enabled", True),
