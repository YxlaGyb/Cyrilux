...
def prepare_4tasks(data_dir: str | None = None, output_dir: str | None = None, n_per_task: int = 20000, seed: int = 42):
    """
...
def conv_to_text(conversations: list, gt: list | None = None) -> str:
...
def prepare_hetero(data_dir: str | None = None, output_dir: str | None = None):
    """
