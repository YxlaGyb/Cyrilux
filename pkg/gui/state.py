"""全局实验状态管理 — 配置 / 任务管线 / 检查点注册.

ExperimentState 单例，通过 StateBridge 广播变更给 PyQt6 信号.
"""
...
class ExperimentState:
    ...
    # 检查点注册表
    checkpoint_registry: list = field(
        default_factory=list,
    )  # [{path, dir, size, step, mtime}, ...]
    ...
    def config_to_kwargs(self) -> dict:
        ...
        int_keys = {
            ...
            "abstraction_replay_interval", "hidden_size",
